...
#SBATCH --gres=gpu:4
#SBATCH --job-name=6_100_10ps
#SBATCH --output=6_100_10ps.out
#SBATCH --error=6_100_10ps.err
...
export MAIN_DIRECTORY=/scratch/users/sahn1/WE_Penta_Alanine  # TODO: set main directory for WE simulation
