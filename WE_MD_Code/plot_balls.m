...
load('diffusion_map_coords_64.txt')
diffusion_map_coords = diffusion_map_coords_64;
...
%% Triazine Regular Plot
load('total_weights_on_each_bin_142.txt')
total_weight = total_weights_on_each_bin_142;
