...
load('flux_total_1ball_1step_beta_20_sc_800_16000_200_v2_1.txt')
load('flux_total_1ball_1step_beta_20_sc_800_16000_400_v2_1.txt')
load('flux_total_1ball_1step_beta_20_sc_800_16000_500_v2_1.txt')
load('flux_total_1ball_1step_beta_20_sc_1000_20000_200_v2_1.txt')
load('flux_total_1ball_1step_beta_20_sc_1000_20000_400_v2_1.txt')
...
plot(flux_total_1ball_1step_beta_20_sc_1000_20000_200_v2_1(1:freq:end,1),flux_total_1ball_1step_beta_20_sc_1000_20000_200_v2_1(1:freq:end,2),'m');
plot(flux_total_1ball_1step_beta_20_sc_1000_20000_400_v2_1(1:freq:end,1),flux_total_1ball_1step_beta_20_sc_1000_20000_400_v2_1(1:freq:end,2),'c');
%axis([1 7000 0 4e-6])
xlabel('# of steps')
ylabel('forward flux')
...
plot(flux_total_1ball_1step_beta_20_sc_1000_20000_200_v2_1(1:freq:end,1),flux_total_1ball_1step_beta_20_sc_1000_20000_200_v2_1(1:freq:end,3),'m');
plot(flux_total_1ball_1step_beta_20_sc_1000_20000_400_v2_1(1:freq:end,1),flux_total_1ball_1step_beta_20_sc_1000_20000_400_v2_1(1:freq:end,3),'c');
%axis([1 7000 0 10e-7])
xlabel('# of steps')
